        ...
        <v-layout row>
            ...
            <v-flex xs12>
                <v-card
                        height="100%">
                    <v-card-text>
                        <h1 class="text-lg-left">Facility 2 Hot Water Control Points</h1>
                        <hr>
                    </v-card-text>
                    <v-container
                            fluid
                    ...
                    >
                        <v-layout row wrap>
                            <v-container fluid grid-list-md>
                                <v-layout row wrap>
                                    <v-card-text>
                                        <h2 class="text-lg-left">Observation Log</h2>
                                    </v-card-text>
                                    <v-flex
                                            v-for="card in cards"
                                            :key="card.title"
                                        ...
                                        <v-card>
                                            <v-card-text>
                                                <router-link to="/locationview"><h3 class="text-lg-left">{{ card.title }}</h3></router-link>
                                                <hr>
                                            </v-card-text>
                    ...
                    >
                        <v-layout row wrap>
                            <v-container fluid grid-list-md>
                                <v-layout row wrap>
                                    <v-card-text>
                                        <h2 class="text-lg-left">Sample Log</h2>
                                    </v-card-text>
                                    <v-flex
                                            v-for="card in cards"
                                            :key="card.title"
                    ...
                    >
                        <v-layout row wrap>
                            <v-container fluid grid-list-md>
                                <v-layout row wrap>
                                    <v-card-text>
                                        <h2 class="text-lg-left">Maintenance Log</h2>
                                    </v-card-text>
                                    <v-flex
                                            v-for="card in cards"
                                            :key="card.title"
